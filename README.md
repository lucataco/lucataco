...
I bridge the gap between ML research and production deployment. I package open-source AI models into reproducible, easy-to-run containers and build developer tooling that makes cutting-edge ML accessible. With 300+ model deployments, I focus on making AI practical and deployable for everyone.
...
|------|-------------|-------|
| [cog-xtts-v2](https://github.com/lucataco/cog-xtts-v2) | Cog wrapper for XTTS-v2 text-to-speech | 82 |
| [cog-flux-schnell](https://github.com/lucataco/cog-flux-schnell) | FLUX.1 schnell image generation wrapper | 75 |
| [cog-flux-dev-lora](https://github.com/lucataco/cog-flux-dev-lora) | LoRA explorer for Flux.1 Dev | 52 |
| [cog-civitai-sdxl-template](https://github.com/lucataco/cog-civitai-sdxl-template) | Deploy CivitAI models on Replicate | 48 |
